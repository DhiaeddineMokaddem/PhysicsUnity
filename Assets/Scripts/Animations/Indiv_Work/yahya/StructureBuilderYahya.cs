...
/// </summary>
public class StructureBuilderYahya : MonoBehaviour
{
    ...
    public float constraintStiffness = 1200.0f;
    public float constraintDamping = 60.0f;
    public float constraintBreakForce = 150.0f;
        ...
        for (int x = 0; x < wallWidth; x++)
        {
            for (int y = 0; y < wallHeight; y++)
            {
                for (int z = 0; z < wallDepth; z++)
                {
                    ...
                    RigidBody3DYahya body = cube.GetComponent<RigidBody3DYahya>();
                    cubeGrid[x, y, z] = body;
    ...
    GameObject CreateCube(Vector3 position, Vector3 size)
    {
        ...
        RigidBody3DYahya body = cube.AddComponent<RigidBody3DYahya>();
        body.mass = cubeMass;
        body.size = size;
    ...
    /// </summary>
    void CreateConstraint(RigidBody3DYahya bodyA, RigidBody3DYahya bodyB)
    {
        ...
        RigidConstraintYahya constraint = constraintObj.AddComponent<RigidConstraintYahya>();
    ...
    public void ClearStructure()
    {
        ...
        RigidConstraintYahya[] constraints = GetComponentsInChildren<RigidConstraintYahya>();
    ...
    public void BuildPyramid(int baseSize, float cubeSpacing)
    {
        ...
        List<RigidBody3DYahya> allBodies = new List<RigidBody3DYahya>();
