...
/// </summary>
public struct CollisionInfoYahya
{
    public RigidBody3DYahya bodyA;
    public RigidBody3DYahya bodyB;
    public Vector3 contactPoint;
    public Vector3 contactNormal;
    public float penetrationDepth;
    
    public CollisionInfoYahya(RigidBody3DYahya a, RigidBody3DYahya b, Vector3 point, Vector3 normal, float depth)
    {
        bodyA = a;
        bodyB = b;
        contactPoint = point;
...
/// </summary>
public class CollisionDetectorYahya : MonoBehaviour
{
    [Header("Paramètres de Collision")]
    public float collisionTolerance = 0.01f;
    public int solverIterations = 4;
    
    private List<CollisionInfoYahya> collisions = new List<CollisionInfoYahya>();

    /// <summary>
    /// Détecte les collisions entre deux cubes (AABB orienté) - PURE MATH
    /// </summary>
    public bool DetectCubeCollision(RigidBody3DYahya cubeA, RigidBody3DYahya cubeB, out CollisionInfoYahya collision)
    {
        collision = new CollisionInfoYahya();
        ...
        collision = new CollisionInfoYahya(cubeA, cubeB, contactPoint, minAxis, minPenetration);
        return true;
    }
    ...
    /// </summary>
    public bool DetectSphereCollision(Vector3 sphereCenter, float sphereRadius, RigidBody3DYahya cube, out CollisionInfoYahya collision)
    {
        collision = new CollisionInfoYahya();
        ...
        if (distSq < sphereRadius * sphereRadius + collisionTolerance)
        {
            ...
            collision = new CollisionInfoYahya(null, cube, closestWorld, normal, penetration);
            return true;
        }
    ...
    public void ResolveCollision(CollisionInfoYahya collision, float elasticity)
    {
        RigidBody3DYahya bodyA = collision.bodyA;
        RigidBody3DYahya bodyB = collision.bodyB;
    ...
    /// </summary>
    private void ResolvePenetration(CollisionInfoYahya collision)
    {
    ...
    private void ApplyFriction(CollisionInfoYahya collision, Vector3 normalImpulse)
    {
        RigidBody3DYahya bodyA = collision.bodyA;
        RigidBody3DYahya bodyB = collision.bodyB;
