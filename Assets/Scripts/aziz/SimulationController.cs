...
public class SimulationController : MonoBehaviour
{
    ...
    public ImpactSphere impactSphere;
    ...
    void Start()
    {
        ...
        if (impactSphere == null)
            impactSphere = FindObjectOfType<ImpactSphere>();
    ...
    void HandleKeyboardInput()
    {
        ...
        // CORRECTION: Impact Multiplier au lieu de Impact Force
        ...
        // NOUVEAU: Contrôle de la vitesse de lancement
    ...
    void UpdateUI()
    {
        if (statsText != null && physicsManager != null)
        {
            ...
            if (impactSphere != null)
            {
                // CORRECTION: Afficher les bonnes statistiques
    ...
    public void ResetSimulation()
    {
        ...
        // Optionnel: reconstruire la structure
        // structureBuilder?.BuildStructure();
    }

    /// <summary>
    /// Lance la sphère d'impact
    /// </summary>
    public void LaunchSphere()
    {
        if (impactSphere != null)
        {
            // Si on veut viser le centre de la structure
            if (structureBuilder != null)
            {
                Vector3 structureCenter = structureBuilder.transform.position;
                structureCenter.y += 2f; // Viser un peu au-dessus du centre
            ...
            Debug.Log($"Sphère lancée à {impactSphere.launchSpeed:F1} m/s!");
        }
    }
    ...
    /// <summary>
    /// CORRECTION: Modifie le multiplicateur d'impact de la sphère
    /// </summary>
    ...
    /// <summary>
    /// NOUVEAU: Modifie la vitesse de lancement de la sphère
    /// </summary>
    ...
    void OnGUI()
    {
        ...
        if (statsText == null)
        {
            ...
            GUILayout.Box("Simulation de Corps Rigides");
            ...
            if (impactSphere != null)
            {
                ...
                impactSphere.impactMultiplier = GUILayout.HorizontalSlider(
                    impactSphere.impactMultiplier, 0.1f, 3f  // Réduit de 10 à 3
                );
